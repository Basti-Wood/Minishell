...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/28 16:04:28 by seftekha          #+#    #+#             */
/*   Updated: 2025/08/07 16:09:22 by seftekha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	process_single_redir(t_redir *redir, t_cmd *cmd)
{
...
int	handle_redirections_in_order(t_cmd *cmd)
{
    ...
    while (redir)
    {
        if (process_single_redir(redir, cmd) == -1)
            return (-1);
        redir = redir->next;
    }
    return (0);
